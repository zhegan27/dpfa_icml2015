...
% vtestHO=wordsTest;
% RBM_RS_SGD
[params,performance]=RBM_RS_SGD(wordsTrain,optimOpts,wordsHeldout,wordsTest);
% return
save(['rcv2_RBM_SGD_K' num2str(K) 'iter_10000'],'params','performance');
