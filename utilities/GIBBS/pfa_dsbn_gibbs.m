function [result,Topics] = pfa_dsbn_gibbs(wordsTrain,wordsHeldout,wordsTest,vocabulary,...
...
for iter = 1:burnin + collection
    ...
    for k = 1:K2        
        ...
        invSigmaW = eye(K3) + Hgam*H3train'; % k2*k2
...
%         figure(111);
%         subplot(1,3,1); imagesc(H1train);colorbar; title('H1');
%         subplot(1,3,2); imagesc(H2train); colorbar; title('H2');
%         subplot(1,3,3); imagesc(H3train); colorbar; title('H3');
%         drawnow;
    end;
